...
As variadas demandas com relação a interface adotada para a aplicação, o principal foco estabelecido para a requisição tornou-se a usabilidade, interatividade e o fácil acesso para os usuários.
